...
if ( ! class_exists( 'Skt_Blocks_Frontend_Styles' ) ) {

	/**
	 * Class Skt_Blocks_Frontend_Styles.
	 */
	final class Skt_Blocks_Frontend_Styles {
		...
		public static function get_responsive_block_advanced_heading_css( $attr, $id ) {
			...
			$id  = '.skt-blocks-block-advanced-heading.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_advanced_columns_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-block-columns.overlay-type-color' => array(
					'background-color' => 'image' === $attr['backgroundType'] ? self::hex_to_rgb( $attr['backgroundImageColor'], $imgopacity ) : '',
				),
				' .skt-blocks-block-columns.overlay-type-gradient.linear' => array(
				...
				' .skt-blocks-block-columns.overlay-type-gradient.radial' => array(
			...
			$id                 = '.skt-blocks-advanced-column-outer-wrap.block-' . $id;
			$css                = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_post_carousel_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-block-post-carousel-title' => array(
				...
				' .skt-blocks-block-post-carousel-title a' => array(
					'color' => $attr['titleColor'],
				),
				' .skt-blocks-block-post-carousel-byline' => array(
				...
				' .skt-blocks-block-post-carousel-excerpt' => array(
					'text-align'  => $attr['blockAlign'],
				...
				' .skt-blocks-block-post-carousel-excerpt p:first-child' => array(
					'margin-bottom' => self::get_css_value( $attr['excerptSpace'], 'px' ),

				),
				' .skt-blocks-block-post-carousel-date' => array(
					'color' => $attr['metaColor'],
				),
				' .skt-blocks-block-post-carousel-author a' => array(
					'color' => $attr['metaColor'],
				),
				' .skt-blocks-block-post-carousel-taxonomy a' => array(
					'color' => $attr['metaColor'],
				),
				' .skt-blocks-block-post-carousel-more-link-wrapper' => array(
				...
				' .skt-blocks-block-post-carousel-more-link.skt-blocks-text-link' => array(
					'color'            => $attr['ctaColor'],
				...
				' .skt-blocks-block-post-carousel-more-link:hover' => array(
				...
				' .skt-blocks-block-post-carousel-text-wrap' => array(
					'text-align' => $attr['blockAlign'],
					'padding'    => self::get_css_value( $attr['contentPadding'], 'px' ),
				),
				' .skt-blocks-block-post-carousel-header' => array(
					'text-align' => $attr['blockAlign'],
				),
				' .skt-blocks-post-carousel-inner' => array(
					'background-color' => $attr['bgColor'],
					'height'           => $inner_height,
				),
				' .skt-blocks-block-post-carousel-image-background img' => array(
					'opacity' => $imgopacity,
				),
			...
			$id                 = '.skt-blocks-block-post-carousel.block-' . $id;
			$css                = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_post_grid_css( $attr, $id ) {
			...
			$selectors = array(
				' .skt-blocks-post-grid-items' => array(
				...
				' .skt-blocks-post-grid-items article' => array(
					'padding' => self::get_css_value( $boxed_content_padding, 'px' ),
				),
				' .skt-blocks-block-post-grid-text' => array(
					'padding'    => self::get_css_value( $content_padding, 'px' ),
					'text-align' => $attr['textAlignment'],
					'display'    => 'block',
				),
				' header .skt-blocks-block-post-grid-title' => array(
					'font-family'    => $attr['titleFontFamily'],
					'font-size'      => self::get_css_value( $attr['titleFontSize'], 'px' ),
					'font-weight'    => $attr['titleFontWeight'],
					'line-height'    => $attr['titleLineHeight'],
				...
				' header .skt-blocks-block-post-grid-title a' => array(
					'color' => $attr['titleColor'],
				),
				' header .skt-blocks-block-post-grid-title a:hover' => array(
					'color' => $attr['titleHoverColor'],
				),
				' .skt-blocks-block-post-grid-byline' => array(
					'color'          => $attr['metaColor'],
					'font-family'    => $attr['metaFontFamily'],
					'font-size'      => self::get_css_value( $attr['metaFontSize'], 'px' ),
					'font-weight'    => $attr['metaFontWeight'],
				...
				' .skt-blocks-block-post-grid-text .skt-blocks-block-post-grid-excerpt' => array(
				...
				' .skt-blocks-block-post-grid-more-link' => $link_styles,
				' .skt-blocks-block-post-grid-more-link:hover' => array(
					'color'           => $attr['readMoreHoverColor'],
					'text-decoration' => 'none',
				),
				' .read-more a'                => $link_styles,
				' .skt-blocks-post-grid-item' => array(
					'margin-bottom' => 0,
				),
				' .is-list .skt-blocks-post-grid-item:not(:last-child)' => array(
					'margin-bottom' => self::get_css_value( $row_gap, 'px' ),
				),
				' .is-list article:last-child' => array(
					'margin-bottom' => 0,
				),
				' .skt-blocks-block-post-grid-image' => array(
					'width' => 'fit-content',
				),
				' .skt-blocks-block-post-grid-image img' => array(
					'border-radius' => self::get_css_value( $attr['imageBorderRadius'], 'px' ),
					'object-fit'    => 'cover',
					'height'        => '100%',
					'margin-bottom' => self::get_css_value( $attr['imageBottomSpacing'], 'px' ),
				),
				' .skt-blocks-block-post-grid-image a' => array(
					'display' => 'block',
				...
				' .skt-blocks-post-pagination-wrap > *' => array(
				...
				' .skt-blocks-post-pagination-wrap > *:last-child' => array(
					'margin-right' => '0',
				),
				' .skt-blocks-post-pagination-wrap > span' => array(
					'border-width'     => self::get_css_value( $attr['paginationBorderWidth'], 'px' ),
			...
			$mobile_selectors = array(
				...
				' .skt-blocks-block-post-grid-more-link' => array(
			...
			$id              = '.skt-blocks-block-post-grid.block-id-' . $id;
			$css             = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			$css['desktop'] .= '.page-template-gutenberg-fullwidth ' . $id . ' .skt-blocks-post-grid-items article {padding:' . ( 'boxed' === $attr['layout'] ? $attr['contentPadding'] ? $attr['contentPadding'] : '0' : '0' ) . 'px;}
    ';
			return $css;
		}
		...
		public static function get_responsive_block_count_up_css( $attr, $id ) {
			...
			$selectors = array(
				...
				'.responsive-count__inner .skt-blocks-count-up__source-wrap.res-countup-icon-design-shaped .skt-blocks-count-up__source-icon' => array(
				...
				'.responsive-count__inner .skt-blocks-count-up__source-wrap.res-countup-icon-design-outline .skt-blocks-count-up__source-icon' => array(
					'border-color'  => $attr['iconShapeColor'],
					'border-radius' => self::get_css_value( $attr['shapeBorderRadius'], 'px' ),
					'padding'       => self::get_css_value( $attr['shapePadding'], 'px' ),
					'border-width'  => self::get_css_value( $attr['shapeBorder'], 'px' ),
				),
				'.responsive-count__inner .skt-blocks-count-up__source-icon svg' => array(
				...
				' .skt-blocks-count-up__source-wrap' => array(
			...
			$id              = '.skt-blocks-block-count-up.block-' . $id;
			$css             = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			$css['desktop'] .= '
            .responsive-count {
		...
		public static function get_responsive_block_blockquote_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-section__video-wrap' => array(
					'opacity' => $imgopacity,
				),
				' .skt-blocks-section-background-image-wrap .skt-blocks-section-background-image' => array(
					'height'        => 100 . '%',
					'opacity'       => $imgopacity,
					'border-radius' => self::get_css_value( $attr['blockBorderRadius'], 'px' ),
				),
				' .skt-blocks-block-blockquote-item .skt-blocks-block-blockquote-quote' => array(
				...
				' .skt-blocks-block-blockquote-text' => array(
					'text-align'  => $attr['quoteAlign'],
				...
				' .skt-blocks-block-blockquote-item' => array(
			...
			$id  = '.skt-blocks-block-blockquote.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
		...
		public static function get_responsive_block_divider_css( $attr, $id ) {
			...
			$selectors        = array(
				...
				' .skt-blocks-spacer-handle' => array(
					'color' => $attr['spacerDividerColor'],
				),
				' .skt-blocks-divider-inner .skt-blocks-divider-content' => array(
					'margin-top'    => self::get_css_value( $attr['spacerHeight'], 'px' ),
					'margin-bottom' => self::get_css_value( $attr['spacerHeight'], 'px' ),
				),
				' .skt-blocks-divider-inner .skt-blocks-divider-content .skt-blocks-divider_hr' => array(
				...
				' .skt-blocks-divider-inner .skt-blocks-divider-content .rgbl-divider__dots' => array(
					'width'        => $attr['spacerDividerWidth'] . '%',
					'margin-left'  => 'left' === $attr['spacerDividerAlignment'] ? 0 : 'auto',
					'margin-right' => 'right' === $attr['spacerDividerAlignment'] ? 0 : 'auto',
				),
				' .skt-blocks-divider-inner .skt-blocks-divider-content .rgbl-divider__dots .rgbl-divider__dot' => array(
					'height'           => self::get_css_value( $attr['spacerDividerHeight'], 'px' ),
					'background-color' => $attr['spacerDividerColor'],
			...
			$id  = '.skt-blocks-block-divider.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_accordian_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-icon-active svg' => array(
					'width'        => self::get_css_value( ( $attr['iconSize'] ), $attr['iconSizeType'] ),
					'height'       => self::get_css_value( ( $attr['iconSize'] ), $attr['iconSizeType'] ),
					'font-size'    => self::get_css_value( ( $attr['iconSize'] ), $attr['iconSizeType'] ),
				...
				' .skt-blocks-accordion-content span' => array(
				...
				' .skt-blocks-accordion-item .skt-blocks-accordion-titles-button.skt-blocks-accordion-titles' => array(
					'flex-direction' => $attr['iconAlign'],
				),
				' .skt-blocks-accordion-titles-button' => array(
					'background-image' => $title_gradient,
				),
				' .skt-blocks-accordion-titles-button .skt-blocks-title' => array(
					'font-family' => $attr['titleFontFamily'],
					'font-size'   => self::get_css_value( $attr['titleFontSize'], 'px' ),
					'font-weight' => $attr['titleFontWeight'],
					'line-height' => $attr['titleLineHeight'],
				),
				' .skt-blocks-accordion-item .skt-blocks-accordion-content' => array(
				...
				' .skt-blocks-accordion-titles-button.skt-blocks-accordion-titles' => array(
				...
				' .skt-blocks-accordion-item-active .skt-blocks-accordion-titles-button.skt-blocks-accordion-titles' => array(
			...
			if ( 'accordion' === $attr['layout'] && true === $attr['inactiveOtherItems'] ) {
				$selectors = array_merge(
					$selectors,
					array(
						' .skt-blocks-accordion-item__outer-wrap .skt-blocks-accordion-content' => array(
							'display' => 'none',
						),
					)
				);
			...
			if ( 'accordion' === $attr['layout'] && true === $attr['expandFirstItem'] ) {
				$selectors = array_merge(
					$selectors,
					array(
						'  .skt-blocks-accordion__wrap > div:first-child > .skt-blocks-accordion-item__outer-wrap .skt-blocks-accordion-content' => array(
							'display' => 'block',
						),
						'  .skt-blocks-accordion__wrap > div:first-child > .skt-blocks-accordion-item__outer-wrap .skt-blocks-accordion-item .skt-blocks-accordion-titles-button .skt-blocks-icon-active' => array(
							'display' => 'inline-block',
						),
						'  .skt-blocks-accordion__wrap > div:first-child > .skt-blocks-accordion-item__outer-wrap .skt-blocks-accordion-item .skt-blocks-accordion-titles-button .skt-blocks-icon' => array(
							'display' => 'none',
						),
					)
				);
			...
			if ( 'grid' === $attr['layout'] ) {
				$selectors = array_merge(
					...
					array(
						...
						'  > div:first-child > .skt-blocks-accordion-item__outer-wrap .skt-blocks-accordion-item .skt-blocks-accordion-titles-button .skt-blocks-icon' => array(
							'display' => 'none',
						),
					)
				);
			...
			$id  = '.skt-blocks-accordion__outer-wrap.skt-blocks-block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_accordian_child_css( $attr, $id ) {
			...
			$id  = '.skt-blocks-accordion-item__outer-wrap.skt-blocks-block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_advanced_column_child_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-block-column' => array_merge(
					array(
				...
				' .skt-blocks-block-column:hover' => array_merge(
					array(
			...
			$id  = '.skt-blocks-advanced-column-child.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
		...
		public static function get_responsive_block_buttons_css( $attr, $id ) {
			...
			$id  = '.skt-blocks-block-buttons.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_buttons_child_css( $attr, $id ) {
			...
			$selectors        = array(
				' .skt-blocks-button__wrapper .skt-blocks-button__icon svg' => array(
					'color'  => $attr['icon_color'],
					'width'  => self::get_css_value( $attr['iconsize'], 'px' ),
					'height' => self::get_css_value( $attr['iconsize'], 'px' ),
				),
				' .skt-blocks-button__wrapper a:hover .skt-blocks-button__icon svg' => array(
					'color' => $attr['icon_hover_color'],
				),
				' .skt-blocks-buttons-repeater.skt-blocks-button__wrapper:hover .skt-blocks-button__link_child, .edit-post-visual-editor.editor-styles-wrapper .wp-block-cover .skt-blocks-buttons-child .skt-blocks-buttons-repeater.skt-blocks-button__wrapper:hover .skt-blocks-button__link_child' => array(
					'color' => $updated_text_h_color,
				),
				' .skt-blocks-1.skt-blocks-button__wrapper' => array(
				...
				' .skt-blocks-buttons-repeater.skt-blocks-button__wrapper' => array(
				...
				' .skt-blocks-buttons-repeater.skt-blocks-button__wrapper div' => array(
					'color' => $attr['inheritFromTheme'] ? '' : ( $attr['color'] ? $attr['color'] : '#000' ),
				),
				' .skt-blocks-buttons-repeater.skt-blocks-button__wrapper:hover' => array(
					'border-color'     => $updated_border_h_color,
					'background-color' => $updated_background_h_color,
				),
				' .skt-blocks-button__icon' => array(
					'margin-left'  => $icon_space_left . 'px',
					'margin-right' => $icon_space_right . 'px',
				),
				' .skt-blocks-buttons-repeater.skt-blocks-button__wrapper.wp-block-button__link' => array(
					'background-color' => '',
				),
			);
			$mobile_selectors = array(
			...
			$id  = '.skt-blocks-buttons-child.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_call_to_action_css( $attr, $id ) {
			...
			$selectors = array(
				' .skt-blocks-cta-button-wrapper .skt-blocks-cta-button' => array(
				...
				' .skt-blocks-cta-button-wrapper:hover .skt-blocks-cta-button' => array(
				...
				' .skt-blocks-cta-button-wrapper:hover' => array(
				...
				' .skt-blocks-cta-link-text' => array(
					'color'       => 'empty' !== $attr['buttonTextColor'] && '#fff' === $attr['ctaColor'] ? $attr['buttonTextColor'] : $attr['ctaColor'], // For compatibility with v1.3.2.
				...
				' .skt-blocks-cta-link-text:hover' => array(
					'color' => 'empty' !== $attr['hbuttonTextColor'] && '#e6f2ff' === $attr['ctaHoverColor'] ? $attr['hbuttonTextColor'] : $attr['ctaHoverColor'], // For compatibility with v1.3.2.
				),

				' .skt-blocks-cta-button__icon svg' => array(
					'fill' => $attr['icon_color'],
				),

				' .skt-blocks-cta-title' => array(
				...
				' .skt-blocks-cta-button-wrapper' => array(
					'color'            => $attr['ctaColor'],
				...
				' .skt-blocks-cta-button__icon' => array(
					'margin' => $cta_icon_margin,
				),
				' .skt-blocks-cta-button' => array(
					'font-family' => $attr['buttonTextFontFamily'],
					'font-size'   => self::get_css_value( $attr['buttonTextFontSize'], 'px' ),
					'font-weight' => $attr['buttonTextFontWeight'],
					'line-height' => $attr['buttonTextLineHeight'],
			...
			$id  = '.skt-blocks-block-call-to-action.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
		...
		public static function get_responsive_block_call_to_action_default_attributes() {
			return array(
				...
				'ctaBackColor'             => '#2091e1',
				'ctaColor'                 => '#fff',
				'buttonSize'               => 'skt-blocks-cta-button-size-medium',
				'buttonShape'              => 'skt-blocks-cta-button-shape-rounded',
				'buttonTarget'             => false,
				'ctaTitle'                 => '',
				'ctaTitleFontFamily'       => '',
				'ctaTextFontFamily'        => '',
		...
		public static function get_responsive_block_card_css( $attr, $id ) {
			...
			$selectors = array(
				' .skt-blocks-card-button-inner .res-button' => array(
					'color'   => 'empty' !== $attr['buttonTextColor'] && '#fff' === $attr['ctaColor'] ? $attr['buttonTextColor'] : $attr['ctaColor'], // For compatibility with v1.3.2.
					'opacity' => $textopacity,
				),

				' .skt-blocks-card-button-inner:hover .res-button' => array(
				...
				' .skt-blocks-card-button-inner .skt-blocks-button__icon svg' => array(
					'fill' => $attr['icon_color'],
				),

				' .skt-blocks-card-button-inner:hover .skt-blocks-button__icon svg' => array(
					'fill' => $attr['icon_hcolor'],
				),

				' .wp-block-skt-blocks-card-item__button-wrapper .skt-blocks-card-button-inner' => array(
					'background-color' => $updated_button_color,
				),

				' .skt-blocks-card-button-inner:hover' => array(
					'background-color' => $updated_buttonh_color,
					'border-color'     => $attr['ctaHoverBorderColor'],
					'background-image' => 'color' === $attr['buttonHbackgroundType'] ? 'none' : $updated_button_background_color,
				),
				...
				' .wp-block-skt-blocks-card-item' => array(
					'border-color'     => 'empty' !== $attr['borderColor'] && '' === $attr['blockBorderColor'] ? $attr['borderColor'] : $attr['blockBorderColor'], // For compatibility with v1.3.2.
					'border-style'     => 'empty' !== $attr['borderStyle'] && 'none' === $attr['blockBorderStyle'] ? $attr['borderStyle'] : $attr['blockBorderStyle'], // For compatibility with v1.3.2.
				...
				' .skt-blocks-card-background-image' => array(
				...
				' .wp-block-skt-blocks-card-item__title' => array(
					'margin-top'    => 0,
					'margin-bottom' => self::get_css_value( $attr['titleSpace'], 'px' ),
					'color'         => $attr['textColor'],
					'line-height'   => $attr['headingLineHeight'],
				...
				' .wp-block-skt-blocks-card-item__subtitle' => array(
					'margin-top'    => 0,
					'margin-bottom' => self::get_css_value( $attr['subtitleSpace'], 'px' ),
					'color'         => $attr['textColor'],
				...
				' .wp-block-skt-blocks-card-item__content' => array(
					'margin-top'    => 0,
					'margin-bottom' => self::get_css_value( $attr['contentSpace'], 'px' ),
					'color'         => $attr['textColor'],
					'line-height'   => $attr['contentLineHeight'],
				...
				' .skt-blocks-card-button-inner' => array(
			...
			$id  = '.skt-blocks-block-card.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
		...
		public static function get_responsive_block_card_default_attributes() {
			return array(
				...
				'ctaBorderStyle'          => 'none',
				'buttonSize'              => 'skt-blocks-button-size-medium',
				'buttoncolorLocation1'    => 0,
				'buttoncolorLocation2'    => 100,
				'buttongradientDirection' => 90,
				'buttonbackgroundColor1'  => '',
		...
		public static function get_responsive_block_content_timeline_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .responsive-timeline__main .skt-blocks-ifb-icon' => array(
					'color' => $attr['iconColor'],
				),

				' .responsive-timeline__main .skt-blocks-ifb-icon svg' => array(
					'fill' => $attr['iconColor'],
				),
			...
			$id  = '.skt-blocks-block-content-timeline.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_expand_css( $attr, $id ) {
			...
			$selectors = array(
				' .skt-blocks-expand-block-content' => array(
					'text-align' => $attr['expandAlignment'],
				),

				' .skt-blocks-expand-title' => array(
					'margin-bottom' => self::get_css_value( $attr['titleSpace'], 'px' ),
					'font-family'   => $attr['titleFontFamily'],
					'font-size'     => self::get_css_value( $attr['titleFontSize'], 'px' ),
					'font-weight'   => $attr['titleFontWeight'],
				...
				' .skt-blocks-expand-less-text' => array(
				...
				' .skt-blocks-expand-more-text' => array(
					'display'       => 'none',
					'margin-bottom' => self::get_css_value( $attr['textSpace'], 'px' ),
					'font-family'   => $attr['textFontFamily'],
					'font-size'     => self::get_css_value( $attr['textFontSize'], 'px' ),
				...
				' .skt-blocks-expand-more-toggle-text' => array(
				...
				' .skt-blocks-expand-less-toggle-text' => array(
					'display'       => 'none',
					'margin-bottom' => self::get_css_value( $attr['linkSpace'], 'px' ),
					'font-family'   => $attr['linkFontFamily'],
					'font-size'     => self::get_css_value( $attr['linkFontSize'], 'px' ),
			...
			$id  = '.skt-blocks-block-expand.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_flipbox_css( $attr, $id ) {
			...
			$selectors        = array(
				...
				' .wp-block-skt-blocks-flip-box' => array(
					'height' => self::get_css_value( $attr['height'], 'px' ),
				),
				' .wp-block-skt-blocks-flip-box .flip-box-inner' => array(
					'transition' => $flipbox_transition,
				),
				' .wp-block-skt-blocks-flip-box .flip-box-front' => array(
				...
				' .wp-block-skt-blocks-flip-box__title' => array(
					'color'       => $attr['frontTextColor'],
				...
				' .wp-block-skt-blocks-flip-box__subtitle' => array(
					'color'       => $attr['frontTextColor'],
				...
				' .wp-block-skt-blocks-flip-box__backtitle' => array(
					'color'       => $attr['backTextColor'],
				...
				' .wp-block-skt-blocks-flip-box__backsubtitle' => array(
					'color'       => $attr['backTextColor'],
				...
				' .wp-block-skt-blocks-flip-box-dashicon-fronticon-wrap' => array(
					'font-size' => self::get_css_value( $attr['iconSize'], 'px' ),
				),
				' .wp-block-skt-blocks-flip-box-dashicon-fronticon-wrap svg' => array(
					'font-size' => self::get_css_value( $attr['iconSize'], 'px' ),
					'fill'      => $attr['iconColor'],
					'height'    => self::get_css_value( $attr['iconSize'], 'px' ),
					'width'     => self::get_css_value( $attr['iconSize'], 'px' ),
				...
				' .wp-block-skt-blocks-flip-box-dashicon-backicon-wrap' => array(
					'font-size' => self::get_css_value( $attr['backIconSize'], 'px' ),
				),
				' .wp-block-skt-blocks-flip-box-dashicon-backicon-wrap svg' => array(
					'font-size' => self::get_css_value( $attr['backIconSize'], 'px' ),
					'fill'      => $attr['backIconColor'],
					'height'    => self::get_css_value( $attr['backIconSize'], 'px' ),
					'width'     => self::get_css_value( $attr['backIconSize'], 'px' ),
				),
				' .wp-block-skt-blocks-flipbox-item__button.wp-block-button__link' => array(
					'border-style'     => $attr['ctaBorderStyle'],
					'border-width'     => self::get_css_value( $attr['ctaBorderWidth'], 'px' ),
					'border-radius'    => self::get_css_value( $attr['ctaBorderRadius'], 'px' ),
					'border-color'     => $attr['ctaBorderColor'],
				...
				' .wp-block-skt-blocks-flipbox-item__button.wp-block-button__link:hover' => array(
			...
			$mobile_selectors = array(
				...
				' .has-medium-gutter.responsive-flipbox-columns__stack-mobile > .wp-block-skt-blocks-flip-box:not(:last-child)' => array(
			...
			$tablet_selectors = array(
				...
				' .has-medium-gutter.responsive-flipbox-columns__stack-tablet > .wp-block-skt-blocks-flip-box:not(:last-child)' => array(
					'margin-bottom' => self::get_css_value( $attr['flipBoxGutterGap'], 'px' ),
				),
				' '               => array(
			...
			$id  = '.skt-blocks-block-flipbox.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_googlemap_css( $attr, $id ) {
			...
			$id  = '.skt-blocks-block-googlemap.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
		...
		public static function get_responsive_block_icon_list_css( $attr, $id ) {
			...
			$selectors        = array(
				' .skt-blocks-icon-list__source-icon svg' => array(
					'width'  => self::get_css_value( $attr['size'], $attr['fontSizeType'] ),
					'height' => self::get_css_value( $attr['size'], $attr['fontSizeType'] ),
				),
				'.skt-blocks-icon-list__layout-horizontal .wp-block-skt-blocks-icons-list-child' => array(
					'margin-left'  => self::get_css_value( $editor_gap / 2, 'px' ),
					'margin-right' => self::get_css_value( $editor_gap / 2, 'px' ),
				),
				'.skt-blocks-icon-list__layout-horizontal .wp-block-skt-blocks-icons-list-child:first-child' => array(
					'margin-left' => '0',
				),
				'.skt-blocks-icon-list__layout-horizontal .wp-block-skt-blocks-icons-list-child:nth-last-child(2)' => array(
					'margin-right' => '0',
				),
				'.skt-blocks-icon-list__layout-vertical .skt-blocks-icon-list__content-wrap' => array(
					'margin-bottom' => self::get_css_value( $editor_gap, 'px' ),
				),
				'.skt-blocks-icon-list__layout-vertical .wp-block-skt-blocks-icons-list-child:last-child .skt-blocks-icon-list__content-wrap' => array(
					'margin-bottom' => '0px',
				),
				' .skt-blocks-icon-list__source-wrap' => array(
				...
				' .skt-blocks-icon-list__source-icon' => array(
					'width'     => self::get_css_value( $attr['size'], $attr['fontSizeType'] ),
					'height'    => self::get_css_value( $attr['size'], $attr['fontSizeType'] ),
					'font-size' => self::get_css_value( $attr['size'], $attr['fontSizeType'] ),
				),
				' .skt-blocks-icon-list__source-image' => array(
					'width'  => self::get_css_value( $attr['size'], $attr['fontSizeType'] ),
					'height' => self::get_css_value( $attr['size'], $attr['fontSizeType'] ),
				),
				' .skt-blocks-icon-list__label-wrap' => array(
					'text-align' => $attr['align'],
				),
				' .skt-blocks-icon-list__wrap' => array(
					'align-items'     => $alignment,
					'justify-content' => $alignment,
				),
				'.skt-blocks-icon-list__layout-horizontal .block-editor-block-list__layout' => array(
					'justify-content'  => $alignment,
					'-webkit-box-pack' => $alignment,
					'-ms-flex-pack'    => $alignment,
				),
				' .skt-blocks-icon-list__label' => array(
			...
			$id  = '.skt-blocks-icon-list__outer-wrap.skt-blocks-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_icon_list_child_css( $attr, $id ) {
			...
			$selectors = array(
				' .skt-blocks-icon-list__content-wrap .skt-blocks-icon-list__source-icon' => array(
					'color' => $attr['icon_color'],
				),
				' .skt-blocks-icon-list__content-wrap .skt-blocks-icon-list__source-icon:hover' => array(
					'color' => $attr['icon_hover_color'],
				),
				' .skt-blocks-icon-list__content-wrap .skt-blocks-icon-list__source-wrap' => array(
					'background-color' => $attr['icon_bg_color'],
					'border-color'     => $attr['icon_border_color'],
				),
				':hover .skt-blocks-icon-list__content-wrap .skt-blocks-icon-list__source-wrap' => array(
					'background-color' => $attr['icon_bg_hover_color'],
					'border-color'     => $attr['icon_border_hover_color'],
				),
				' .skt-blocks-icon-list__content-wrap .skt-blocks-icon-list__source-icon svg' => array(
					'fill' => $attr['icon_color'],
				),
				':hover .skt-blocks-icon-list__content-wrap .skt-blocks-icon-list__source-icon svg' => array(
					'fill' => $attr['icon_hover_color'],
				),
				' .skt-blocks-icon-list__content-wrap .skt-blocks-icon-list__label' => array(
					'color' => $attr['label_color'],
				),
				':hover .skt-blocks-icon-list__content-wrap .skt-blocks-icon-list__label' => array(
			...
			$id  = '.skt-blocks-icon-list-repeater.skt-blocks-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_image_boxes_css( $attr, $id ) {
			...
			$selectors = array(
				...
				':hover .skt-blocks-add-image' => array(
				...
				' .skt-blocks-imagebox-image' => array(
					'width'     => $attr['imageSize'],
					'max-width' => 100 . '%',
				),
				' .wp-block-skt-blocks-image-boxes-block-item__title' => array(
					'font-family'   => $attr['titleFontFamily'],
					'font-weight'   => $attr['titleFontWeight'],
					'font-size'     => self::get_css_value( $attr['titleFontSize'], 'px' ),
					'line-height'   => $attr['titleLineHeight'],
				...
				' .wp-block-skt-blocks-image-boxes-block-item__description' => array(
				...
				'.skt-blocks-block-image-boxes-0' => array(
					'background-image' => $background_image_first,
				),
				'.skt-blocks-block-image-boxes-1' => array(
					'background-image' => $background_image_second,
				),
				'.skt-blocks-block-image-boxes-2' => array(
					'background-image' => $background_image_third,
				),
				'.skt-blocks-block-image-boxes-3' => array(
			...
			$id             = '.skt-blocks-block-image-boxes.block-' . $id;
			$css            = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			$css['mobile'] .= '
                .wp-block-skt-blocks-image-boxes-block__inner a {
		...
		public static function get_responsive_block_image_slider_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-gallery--item figure' => array(
					'height' => ( $attr['height'] - ( $attr['blockBorderWidth'] ? $attr['blockBorderWidth'] * 2 : 0 ) ) . 'px',
				),

				' .has-carousel-lrg .skt-blocks-gallery--item' => array(
					'width' => self::get_css_value( $attr['width'], 'px' ),
				),

				' .skt-blocks-gallery--item' => array(
			...
			$id  = '.skt-blocks-block-image-slider.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_info_block_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-ifb-image-icon-content.skt-blocks-ifb-imgicon-wrap' => array(
				...
				' .skt-blocks-ifb-icon:hover' => array(
				...
				' .skt-blocks-ifb-image-content > img' => array(
				...
				' .skt-blocks-ifb-separator' => array(
				...
				' .skt-blocks-ifb-cta-button' => array(
				...
				' .skt-blocks-ifb-cta-button .skt-blocks-inline-editing' => array(
				...
				' .skt-blocks-ifb-cta-button:hover' => array(
					'background-color' => $updated_background_h_color,
				...
				' .skt-blocks-ifb-cta-button:hover .skt-blocks-inline-editing' => array(
				...
				' .skt-blocks-ifb-icon svg' => array(
					'fill' => $attr['icon_color'],
				),

				' .skt-blocks-ifb-icon:hover svg' => array(
					'fill' => $attr['icon_hcolor'],
				),

				' .skt-blocks-infobox__content-wrap' => array(
					'text-align' => ( 'above-title' === $attr['imgiconPosition'] || 'below-title' === $attr['imgiconPosition'] ) ? $attr['resheadingAlign'] : '',
				),

				' .skt-blocks-infobox__content-wrap .skt-blocks-ifb-title' => array(
					'font-size' => self::get_css_value( $attr['resheadFontSize'], 'px !important' ),
				),

				' .skt-blocks-infobox__content-wrap .skt-blocks-ifb-desc' => array(
				...
				' .skt-blocks-ifb-title-prefix' => array(
				...
				' .skt-blocks-infobox-cta-link' => array(
				...
				' .skt-blocks-inline-editing ' => array(
					'color'     => $attr['resctaLinkColor'],
					'font-size' => self::get_css_value( $attr['resctaFontSize'], 'px' ),
				),

				' .skt-blocks-infobox-cta-link.skt-blocks-ifb-cta-button' => array(
			...
			$mobile_selectors = array(
				...
				' .skt-blocks-infobox__content-wrap.skt-blocks-infobox-stacked-mobile .skt-blocks-ifb-content' => array(
					'text-align' => $attr['alignment'],
				),
				' .skt-blocks-infobox__content-wrap.skt-blocks-infobox-stacked-mobile .skt-blocks-ifb-icon-wrap' => array(
					'text-align' => $attr['alignment'],
				),
				' .skt-blocks-infobox__content-wrap.skt-blocks-infobox-stacked-mobile .skt-blocks-ifb-imgicon-wrap' => array(
					'text-align' => $attr['alignment'],
				),
			...
			$tablet_selectors = array(
				...
				' .skt-blocks-infobox__content-wrap.skt-blocks-infobox-stacked-tablet .skt-blocks-ifb-content' => array(
					'text-align' => $attr['alignment'],
				),

				' .skt-blocks-infobox__content-wrap.skt-blocks-infobox-stacked-tablet .skt-blocks-ifb-icon-wrap' => array(
					'text-align' => $attr['alignment'],
				),

				' .skt-blocks-infobox__content-wrap.skt-blocks-infobox-stacked-tablet .skt-blocks-ifb-imgicon-wrap' => array(
					'text-align' => $attr['alignment'],
				),
			...
			$id  = '.skt-blocks-block-info-block.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_post_timeline_css( $attr, $id ) {
			...
			$selectors = array(
				' .skt-blocks-timeline__icon-new svg' => array(
					'width'  => self::get_css_value( $attr['iconSize'], 'px' ),
					'height' => self::get_css_value( $attr['iconSize'], 'px' ),
					'fill'   => $attr['iconColor'],
				),
				' .skt-blocks-timeline__marker' => array(
				...
				' .skt-blocks-timeline__link_parent:hover' => array(
					'background-color' => $attr['continuebghColor'],
					'border'           => '1px solid ' . $attr['borderHColor'] . '',
				),
				' .skt-blocks-timeline__link_parent .skt-blocks-timeline__link' => array(
				...
				' .skt-blocks-timeline__link_parent:hover .skt-blocks-timeline__link' => array(
					'color' => $attr['hColor'] . '!important',
				),
				'.skt-blocks-timeline__center-block .skt-blocks-timeline__marker' => array(
					'margin-left'  => self::get_css_value( $attr['horSpace'], 'px' ),
					'margin-right' => self::get_css_value( $attr['horSpace'], 'px' ),
				),
				'.skt-blocks-timeline__left-block .skt-blocks-timeline__day-new' => array(
					'margin-left' => self::get_css_value( $attr['horSpace'], 'px' ),
				),
				'.skt-blocks-timeline__right-block .skt-blocks-timeline__day-new' => array(
					'margin-right' => self::get_css_value( $attr['horSpace'], 'px' ),
				),
				' .skt-blocks-timeline__field.skt-blocks-timeline__field-wrap' => array(
					'margin-bottom' => self::get_css_value( $attr['verSpace'], 'px' ),
				),
				' .skt-blocks-timeline__left-block .skt-blocks-timeline__line' => array(
					'left' => 'calc(' . $attr['bgSize'] . '/2)px',
				),
				' .skt-blocks-timeline__right-block .skt-blocks-timeline__line' => array(
					'right' => 'calc(' . $attr['bgSize'] . '/2)px',
				),
				' .skt-blocks-timeline__main .skt-blocks-timeline__post p' => array(
					'line-height' => $attr['contentLineHeight'],
				),
				' .skt-blocks-timeline__events-new' => array(
					'margin-bottom' => self::get_css_value( $attr['blockSpace'], 'px' ),
				),
				' .skt-blocks-timeline__events-new .skt-blocks-timeline__events-inner-new' => array(
					'background-color' => $attr['bgColor']
					? $attr['bgColor'] : '#e4e4e4',
					'border-radius'    => self::get_css_value( $attr['borderRadius'], 'px' ),
				),
				' .skt-blocks-timeline__date-hide.skt-blocks-timeline__date-inner .skt-blocks-timeline__date-new' => array(
					'line-height' => $attr['dateLineHeight'],
					'font-weight' => $attr['dateFontWeight'],
					'font-size'   => self::get_css_value( $attr['dateFontSize'], 'px' ),
					'font-family' => $attr['dateFontFamily'],
				),
				' .skt-blocks-content' => array(
					'padding' => self::get_css_value( $attr['contentPadding'], 'px' ),
				),
				' .skt-blocks-block-post-timeline-title' => array(
					'margin-bottom' => self::get_css_value( $attr['headingSpace'], 'px' ),
				),
				' .skt-blocks-block-post-timeline-title .skt-blocks-block-post-timeline-title-heading' => array(
					'color'       => $attr['headingColor']
				...
				' .skt-blocks-block-post-timeline-byline' => array(
					'margin-bottom' => self::get_css_value( $attr['authorSpace'], 'px' ),
				),
				' .skt-blocks-block-post-timeline-author .skt-blocks-text-link' => array(
				...
				' .skt-blocks-block-post-timeline-excerpt .skt-blocks-timeline__post' => array(
					'color'         => $attr['textColor']
				...
				' .skt-blocks-timeline__date-new.skt-blocks-timeline__date-outer' => array(
					'line-height' => $attr['dateLineHeight'],
					'font-weight' => $attr['dateFontWeight'],
					'font-size'   => self::get_css_value( $attr['dateFontSize'], 'px' ),
					'font-family' => $attr['dateFontFamily'],
				),
				' .skt-blocks-timeline__main .skt-blocks-timeline__line__inner' => array(
					'background-color' => $attr['separatorFillColor'],
				),
				' .skt-blocks-timeline__main .skt-blocks-timeline__marker.skt-blocks-timeline__in-view-icon' => array(
					'background'   => $attr['iconBgFocus'],
					'border-color' => $attr['borderFocus'],
					'color'        => $attr['iconFocus'],
				),

				' .skt-blocks-timeline__main .skt-blocks-timeline__marker.skt-blocks-timeline__in-view-icon svg' => array(
					'fill' => $attr['iconFocus'],
				),

				' .skt-blocks-timeline__main .skt-blocks-timeline__marker.skt-blocks-timeline__in-view-icon .skt-blocks-timeline__icon-new' => array(
					'color' => $attr['iconFocus'],
				),
			);

			$mobile_selectors = array(
				' .skt-blocks-timeline__center-block.skt-blocks-timeline__responsive-mobile .skt-blocks-timeline__line' => array(
					'left'  => 'calc(' . $attr['bgSize'] . '/2)px',
					'right' => 'calc(' . $attr['bgSize'] . '/2)px',
				),
				' .skt-blocks-timeline__left-block.skt-blocks-timeline__responsive-mobile .skt-blocks-timeline__line' => array(
					'left' => 'calc(' . $attr['bgSize'] . '/2)px',
				),
				' .skt-blocks-timeline__right-block.skt-blocks-timeline__responsive-mobile .skt-blocks-timeline__line' => array(
					'right' => 'calc(' . $attr['bgSize'] . '/2)px',
				),
				' .skt-blocks-timeline__link_parent .skt-blocks-timeline__link' => array(
					'font-size' => self::get_css_value( $attr['continueFontSizeMobile'], 'px' ),
			...
			$tablet_selectors = array(
				' .skt-blocks-timeline__center-block.skt-blocks-timeline__responsive-tablet .skt-blocks-timeline__line' => array(
					'left'  => 'calc(' . $attr['bgSize'] . '/2)px',
					'right' => 'calc(' . $attr['bgSize'] . '/2)px',
				),
				' .skt-blocks-timeline__left-block.skt-blocks-timeline__responsive-tablet .skt-blocks-timeline__line' => array(
					'left' => 'calc(' . $attr['bgSize'] . '/2)px',
				),
				' .skt-blocks-timeline__right-block.skt-blocks-timeline__responsive-tablet .skt-blocks-timeline__line' => array(
					'right' => 'calc(' . $attr['bgSize'] . '/2)px',
				),
				' .skt-blocks-timeline__link_parent .skt-blocks-timeline__link' => array(
					'font-size' => self::get_css_value( $attr['continueFontSizeTablet'], 'px' ),
			...
			$id  = '.skt-blocks-block-post-timeline.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_pricing_list_css( $attr, $id ) {
			...
			$selectors        = array(
				' .skt-blocks-pricing-list-item-wrap' => array(
					'margin-bottom' => self::get_css_value( $attr['rowGap'], 'px' ),
					'padding-left'  => self::get_css_value( $attr['columnGap'] / 2, 'px' ),
					'padding-right' => self::get_css_value( $attr['columnGap'] / 2, 'px' ),
				),
				' .skt-blocks-pricing-list-item-wrap .skt-blocks-pricing-list-item-content' => array(
				...
				' .skt-blocks-pricing-list-item-image-wrap .skt-blocks-pricing-list-item-image' => array(
					'height'    => 'auto',
					'width'     => self::get_css_value( $attr['imageWidth'], 'px' ),
					'max-width' => self::get_css_value( $attr['imageWidth'], 'px' ),
				),
				' .skt-blocks-pricing-list-item-title' => array(
					'color'         => $attr['titleColor'],
					'line-height'   => $attr['titleLineHeight'],
					'font-weight'   => $attr['titleFontWeight'],
					'font-size'     => self::get_css_value( $attr['titleFontSize'], 'px' ),
				...
				' .skt-blocks-pricing-list-item-description' => array(
				...
				' .skt-blocks-pricing-list-item-price-wrap' => array(
				...
				' .skt-blocks-pricing-list-item-separator-wrap' => array(
					'justify-content' => $align,
				),
				' .skt-blocks-pricing-list-item-separator' => array(
			...
			$id  = '.skt-blocks-block-pricing-list.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_pricing_table_css( $attr, $id ) {
			...
			$selectors = array(
				' .wp-block-skt-blocks-pricing-table-item__button' => array(
					'color'            => $attr['ctaColor'] . '!important',
					'display'          => 'block',
					'background-color' => $updated_button_background_color,
				...
				' .wp-block-skt-blocks-pricing-table-item__button:hover' => array(
					'color'            => $attr['ctaHoverColor'] . '!important',
				...
				' .wp-block-skt-blocks-pricing-table-item.background-type-image' => array(
				...
				' .skt-blocks-pricing-table-background-image' => array(
					'height'  => '100%',
					'opacity' => $blockimgopacity,
				),

				' .wp-block-skt-blocks-pricing-table-item' => array(
				...
				' .wp-block-skt-blocks-pricing-table-item__title' => array(
					'color'         => $attr['titleColor'],
					'line-height'   => $attr['titleLineHeight'],
					'font-weight'   => $attr['titleFontWeight'],
					'font-size'     => self::get_css_value( $attr['titleFontSize'], 'px' ),
				...
				' .wp-block-skt-blocks-pricing-table-item__price-wrapper' => array(
					'margin-bottom'   => self::get_css_value( $attr['priceSpace'], 'px' ),
					'justify-content' => $align_style,
				),

				' .wp-block-skt-blocks-pricing-table-item__currency' => array(
				...
				' .wp-block-skt-blocks-pricing-table-item__amount' => array(
					'color'       => $attr['priceColor'],
				...
				' .wp-block-skt-blocks-pricing-table-item__price_suffix' => array(
				...
				' .wp-block-skt-blocks-pricing-table-item__sub_price' => array(
				...
				' .wp-block-skt-blocks-pricing-table-item__features' => array(
				...
				' .skt-blocks-pricing-image' => array(
					'width' => self::get_css_value( $attr['imageWidth'], 'px' ),
				),
			...
			$mobile_selectors = array(
				...
				' .wp-block-skt-blocks-pricing-table__inner' => array(
					'flex-direction' => 'column',
				),
				' .wp-block-skt-blocks-pricing-table-item__price-wrapper' => array(
			...
			$id  = '.skt-blocks-block-pricing-table.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_shape_divider_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .wp-block-skt-blocks-shape-divider__svg-wrapper' => array(
					'min-height' => self::get_css_value( $attr['shapeHeight'], 'px' ),
				),

				' .wp-block-skt-blocks-shape-divider__alt-wrapper' => array(
			...
			$id  = '.skt-blocks-block-shape-divider.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
		...
		public static function get_responsive_block_team_css( $attr, $id ) {
			...
			$selectors = array(
				' .skt-blocks-team-avatar-wrapper' => array(
					'text-align' => $attr['alignment'],
					'text-align' => '-webkit-' . $attr['alignment'],
				),

				' .skt-blocks-team-avatar' => array(
					'width'         => self::get_css_value( $attr['imageWidth'], 'px' ),
				...
				' .skt-blocks-team-designation' => array(
				...
				' .skt-blocks-team-description' => array(
					'color'         => $attr['descriptionColor'],
					'font-family'   => $attr['descriptionFontFamily'],
					'font-size'     => self::get_css_value( $attr['descriptionFontSize'], 'px' ),
					'font-weight'   => $attr['descriptionFontWeight'],
				...
				' .skt-blocks-team-social-icons .dashicons.dashicons-twitter' => array(
				...
				' .skt-blocks-team-social-icons .dashicons.dashicons-facebook' => array(
					'color'           => $attr['socialIconColor'],
					'font-size'       => self::get_css_value( $attr['iconSize'], 'px' ),
					'text-decoration' => 'none',
					'height'          => self::get_css_value( $attr['iconSize'], 'px' ),
				...
				' .skt-blocks-team-social-icons .dashicons.dashicons-linkedin' => array(
					'color'           => $attr['socialIconColor'],
					'font-size'       => self::get_css_value( $attr['iconSize'], 'px' ),
					'text-decoration' => 'none',
					'height'          => self::get_css_value( $attr['iconSize'], 'px' ),
				...
				' .skt-blocks-team-social-icons .dashicons.dashicons-instagram' => array(
					'color'           => $attr['socialIconColor'],
					'font-size'       => self::get_css_value( $attr['iconSize'], 'px' ),
					'text-decoration' => 'none',
					'height'          => self::get_css_value( $attr['iconSize'], 'px' ),
				...
				' .skt-blocks-team-social-icons .dashicons.dashicons-email' => array(
					'color'           => $attr['socialIconColor'],
					'font-size'       => self::get_css_value( $attr['iconSize'], 'px' ),
					'text-decoration' => 'none',
					'height'          => self::get_css_value( $attr['iconSize'], 'px' ),
				...
				' .skt-blocks-team-social-icons .dashicons.dashicons-youtube' => array(
					'color'           => $attr['socialIconColor'],
					'font-size'       => self::get_css_value( $attr['iconSize'], 'px' ),
					'text-decoration' => 'none',
					'height'          => self::get_css_value( $attr['iconSize'], 'px' ),
				...
				' .skt-blocks-team-social-icons .dashicons.dashicons-pinterest' => array(
					'color'           => $attr['socialIconColor'],
					'font-size'       => self::get_css_value( $attr['iconSize'], 'px' ),
					'text-decoration' => 'none',
					'height'          => self::get_css_value( $attr['iconSize'], 'px' ),
				...
				' .skt-blocks-team-social-icons a' => array(
					'line-height'      => 'initial',
				...
				' .skt-blocks-team-social-icons li:hover a' => array(
				...
				' .skt-blocks-team-social-icons li:hover .dashicons' => array(
					'color' => $attr['socialIconHoverColor'] . '!important',
				),

				' .wp-block-skt-blocks-team' => array(
			...
			$id  = '.wp-block-skt-blocks-team-wrapper.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
		...
		public static function get_responsive_block_testimonial_css( $attr, $id ) {
			...
			$selectors = array(
				' .wp-block-skt-blocks-testimonial:last-child' => array(
					'margin-bottom' => '0 !important',
				),
				' .skt-blocks-testimonial-text' => array(
				...
				' .skt-blocks-testimonial-info' => array(
					'margin-bottom' => self::get_css_value( $attr['titleSpacing'], 'px' ),
				),
				' .skt-blocks-testimonial-info .skt-blocks-testimonial-inner-block .skt-blocks-testimonial-avatar-wrap' => array(
					'padding-right' => self::get_css_value( $attr['imageSpacing'], 'px' ),
				),
				' .skt-blocks-testimonial-info .skt-blocks-testimonial-inner-block .skt-blocks-testimonial-avatar-wrap .skt-blocks-testimonial-image-wrap' => array(
					'height' => self::get_css_value( $attr['imageWidth'], 'px' ),
					'width'  => self::get_css_value( $attr['imageWidth'], 'px' ),
				),
				' .skt-blocks-testimonial-avatar' => array(
					'height' => self::get_css_value( $attr['imageWidth'], 'px' ),
					'width'  => self::get_css_value( $attr['imageWidth'], 'px' ),
				),
				' .skt-blocks-testimonial-details .skt-blocks-testimonial-name' => array(
				...
				' .skt-blocks-testimonial-details .skt-blocks-testimonial-title' => array(
				...
				' .testimonial-box.skt-blocks-block-testimonial' => array(
					'box-shadow' =>
						self::get_css_value( $attr['boxShadowHOffset'], 'px' ) .
						' ' .
						self::get_css_value( $attr['boxShadowVOffset'], 'px' ) .
				...
				' .skt-blocks-block-testimonial:hover' => array(
					'box-shadow' =>
						self::get_css_value( $attr['hoverboxShadowHOffset'], 'px' ) .
						' ' .
						self::get_css_value( $attr['hoverboxShadowVOffset'], 'px' ) .
				...
				' .skt-blocks-block-testimonial' => array(
					'background-image'    => $bggradient,
					'background-size'     => $attr['backgroundSize'],
					'background-repeat'   => $attr['backgroundRepeat'],
					'background-position' => $attr['backgroundPosition'],
			...
			$id  = '.skt-blocks-block-testimonial.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_testimonial_slider_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-testimonial__wrap .skt-blocks-tm__content' => array(
					'border-width'  => 999 !== $attr['borderWidth'] && 1 === $attr['blockBorderWidth'] ? self::get_css_value( $attr['borderWidth'], 'px' ) : self::get_css_value( $attr['blockBorderWidth'], 'px' ), // For compatibility with v1.3.2.
					'border-color'  => 'empty' !== $attr['borderColor'] && '' === $attr['blockBorderColor'] ? $attr['borderColor'] : $attr['blockBorderColor'],  // For compatibility with v1.3.2.
					'border-style'  => 'empty' !== $attr['borderStyle'] && 'none' === $attr['blockBorderStyle'] ? $attr['borderStyle'] : $attr['blockBorderStyle'],  // For compatibility with v1.3.2.
					'border-radius' => 999 !== $attr['borderRadius'] && '' === $attr['blockBorderRadius'] ? self::get_css_value( $attr['borderRadius'], 'px' ) : self::get_css_value( $attr['blockBorderRadius'], 'px' ),  // For compatibility with v1.3.2.
				...
				' .skt-blocks-tm__image img' => array(
					'width'     => self::get_css_value( $attr['imageWidth'], 'px' ),
					'max-width' => self::get_css_value( $attr['imageWidth'], 'px' ),
				),
				' .skt-blocks-testimonial__wrap.skt-blocks-tm__bg-type-color .skt-blocks-tm__content' => array(
					'background-color' => $attr['backgroundColor'],
				),
				' .skt-blocks-testimonial__wrap.skt-blocks-tm__bg-type-image .skt-blocks-tm__content' => array(
					'background-image'      => $updated_background_image,
					'background-position'   => $attr['backgroundImagePosition'],
				...
				' .skt-blocks-testimonial__wrap.skt-blocks-tm__bg-type-image .skt-blocks-tm__overlay' => array(
				...
				' .skt-blocks-testimonial__wrap' => array(
					'padding-left'  => self::get_css_value( $attr['columnGap'] / 2, 'px' ),
					'padding-right' => self::get_css_value( $attr['columnGap'] / 2, 'px' ),
					'margin-bottom' => self::get_css_value( $attr['rowGap'], 'px' ),
				),
				' .skt-blocks-testimonial__wrap .skt-blocks-tm__image-content' => array(
			...
			$id  = '.skt-blocks-testomonial__outer-wrap.skt-blocks-block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_section_css( $attr, $id ) {
			...
			$selectors = array(
				' > .skt-blocks-block-section' => array(
				...
				' > .responsive-section-wrap.skt-blocks-block-section' => array(
					'border-width'     => self::get_css_value( $attr['blockBorderWidth'], 'px' ),
					'border-color'     => $attr['blockBorderColor'],
					'border-style'     => $attr['blockBorderStyle'],
					'border-radius'    => self::get_css_value( $attr['blockBorderRadius'], 'px' ),
			...
			$id              = '.skt-blocks-block-section-outer-wrap.block-' . $id;
			$css             = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			$css['desktop'] .= '
		...
		public static function get_responsive_block_video_popup_css( $attr, $id ) {
			...
			$selectors = array(
				' .skt-blocks-video-popup__wrapper' => array(
				...
				' .skt-blocks-video-popup__play-button svg' => array(
			...
			$id  = '.skt-blocks-block-video-popup.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_table_of_contents_css( $attr, $id ) {
			...
			<script>
				( function( $ ) {
					...
					RBEATableOfContents = {
						...
						init: function() {
							$( document ).on( "click",'.skt-blocks-toc__title-wrap', RBEATableOfContents._toggleCollapse )
						},

						_toggleCollapse: function( e ) {
							if ( $( this ).find( '.skt-blocks-toc__collapsible-wrap' ).length > 0 ) {
								let $root = $( this ).closest( '.wp-block-skt-blocks-table-of-contents' )
								if ( $root.hasClass( 'skt-blocks-toc__collapse' ) ) {
									$root.removeClass( 'skt-blocks-toc__collapse' );
								} else {
									$root.addClass( 'skt-blocks-toc__collapse' );
								}
							}
						},
						...
						_run: function( attr, id ) {
							var $this_scope = $( id );
							if ( $this_scope.find( '.skt-blocks-toc__collapsible-wrap' ).length > 0 ) {
								$this_scope.find( '.skt-blocks-toc__title-wrap' ).addClass( 'skt-blocks-toc__is-collapsible' );
							}
						},
					}
			...
			$selectors = array(
				...
				' .skt-blocks-toc__title-wrap' => array(
				...
				' .skt-blocks-toc__title-wrap:hover' => array(
					'color'            => $attr['headingColorHover'],
					'background-color' => $attr['headingBgColorHover'],
				),
				' .skt-blocks-toc__list-wrap' => array(
					'font-family'         => $attr['contentFontFamily'],
					'font-weight'         => $attr['contentFontWeight'],
					'font-size'           => self::get_css_value( $attr['contentFontSize'], 'px' ),
					'line-height'         => $attr['contentLineHeight'],
				...
				' .skt-blocks-toc__list-wrap .skt-blocks-toc__list li a' => array(
					'color' => $attr['bodyColor'],
				),
				' .skt-blocks-toc__list-wrap:hover' => array(
					'background-color' => $attr['bodyBgColorHover'],
				),
				' .skt-blocks-toc__list-wrap:hover .skt-blocks-toc__list li a' => array(
					'color' => $attr['bodyColorHover'],
				),
				' .skt-blocks-toc__wrap' => array(
			...
			$id  = '.skt-blocks-block-table-of-contents.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
		...
		public static function get_responsive_block_how_to_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-block-how-to-main-heading' => array(
				...
				' .skt-blocks-block-how-to-sub-heading-time' => array(
				...
				' .skt-blocks-block-how-to-time-value' => array(
					'color'          => $attr['descriptionColor'],
				...
				' .skt-blocks-block-how-to-sub-heading-cost' => array(
					'color'          => $attr['secondaryHeadingColor'],
					'display'        => 'inline',
					'letter-spacing' => self::get_css_value( $attr['subHeadingLetterSpacing'], 'px' ),
					'line-height'    => $attr['subHeadingLineHeight'],
				...
				' .skt-blocks-block-how-to-cost-value' => array(
					'color'          => $attr['descriptionColor'],
					'display'        => 'inline',
					'letter-spacing' => self::get_css_value( $attr['descriptionLetterSpacing'], 'px' ),
					'line-height'    => $attr['descriptionLineHeight'],
				...
				' .skt-blocks-block-how-to-sub-heading-tools' => array(
					'color'          => $attr['secondaryHeadingColor'],
					'letter-spacing' => self::get_css_value( $attr['subHeadingLetterSpacing'], 'px' ),
					'line-height'    => $attr['subHeadingLineHeight'],
					'font-family'    => $attr['subHeadingFontFamily'],
				...
				' .skt-blocks-block-how-to-tools-list-item' => array(
					'color'          => $attr['descriptionColor'],
					'letter-spacing' => self::get_css_value( $attr['descriptionLetterSpacing'], 'px' ),
					'font-family'    => $attr['descriptionFontFamily'],
					'font-size'      => self::get_css_value( $attr['descriptionFontSize'], 'px' ),
				...
				' .skt-blocks-block-how-to-sub-heading-materials' => array(
					'color'          => $attr['secondaryHeadingColor'],
					'letter-spacing' => self::get_css_value( $attr['subHeadingLetterSpacing'], 'px' ),
					'line-height'    => $attr['subHeadingLineHeight'],
					'font-family'    => $attr['subHeadingFontFamily'],
				...
				' .skt-blocks-block-how-to-materials-list-item' => array(
					'color'          => $attr['descriptionColor'],
					'letter-spacing' => self::get_css_value( $attr['descriptionLetterSpacing'], 'px' ),
					'font-family'    => $attr['descriptionFontFamily'],
					'font-size'      => self::get_css_value( $attr['descriptionFontSize'], 'px' ),
				...
				' .skt-blocks-block-how-to-sub-heading-steps' => array(
					'color'          => $attr['secondaryHeadingColor'],
					'display'        => 'inline',
					'letter-spacing' => self::get_css_value( $attr['subHeadingLetterSpacing'], 'px' ),
					'line-height'    => $attr['subHeadingLineHeight'],
				...
				' .skt-blocks-block-how-to-time-area' => array(
					'margin-top' => self::get_css_value( $attr['rowGap'], 'px' ),
				),
				' .skt-blocks-block-how-to-cost-area' => array(
					'margin-top' => self::get_css_value( $attr['rowGap'], 'px' ),
				),
				' .skt-blocks-block-how-to-tools-area' => array(
					'margin-top' => self::get_css_value( $attr['rowGap'], 'px' ),
				),
				' .skt-blocks-block-how-to-materials-area' => array(
					'margin-top' => self::get_css_value( $attr['rowGap'], 'px' ),
				),
				' .skt-blocks-block-how-to-steps-area' => array(
					'margin-top' => self::get_css_value( $attr['rowGap'], 'px' ),
				),
				' .skt-blocks-block-how-to-main-image' => array(
					'border'        => $border,
					'border-radius' => $border_rad,
				),
				' .skt-blocks-block-how-to-steps .wp-block-skt-blocks-info-block' => array(
			...
			$id  = '.skt-blocks-block-how-to.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_inline_notice_css( $attr, $id ) {
			...
			$attr          = array_merge( $defaults, (array) $attr );
			$base_selector = '.skt-blocks-block-inline-notice.block-';
			...
			$selectors = array(
				...
				' .skt-blocks-block-inline-notice-title-area' => array(
				...
				' .skt-blocks-block-inline-notice-title' => array(
					'color'          => $attr['titleColor'],
					'font-family'    => $attr['titleFontFamily'],
					'font-size'      => self::get_css_value( $attr['titleFontSize'], 'px' ),
					'font-weight'    => $attr['titleFontWeight'],
				...
				' .skt-blocks-block-inline-notice-svg > svg' => array(
					'height'       => '17px',
					'width'        => '17px',
					'margin-right' => '10px',
				),
				' .skt-blocks-block-inline-notice-content-area' => array(
					'background-color' => $attr['contentBgColor'],
					'border-bottom'    => $border_values,
					'border-left'      => $border_left,
					'border-right'     => $border_values,
				),
				' .skt-blocks-block-inline-notice-content' => array(
					'color'          => $attr['contentColor'],
					'font-family'    => $attr['contentFontFamily'],
					'font-size'      => self::get_css_value( $attr['contentFontSize'], 'px' ),
					'font-weight'    => $attr['contentFontWeight'],
			...
			$id  = '.skt-blocks-block-inline-notice.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_call_mail_button_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-call-mail-button-button-container' => array(
					'width'            => $button_width_css,
					'border'           => $button_border,
					'background-color' => $button_background,
					'border-radius'    => $button_border_radius,
				),
				' .skt-blocks-call-mail-button-text' => array(
					'color'       => $text_color,
					'font-family' => $attr['textFontFamily'],
				...
				' .skt-blocks-call-mail-button-icon' => array(
					'fill' => $text_color,
				),
				' .skt-blocks-call-mail-button-icon svg' => array(
					'height' => self::get_css_value( $attr['iconSize'], 'px' ) . ' !important',
					'width'  => self::get_css_value( $attr['iconSize'], 'px' ) . ' !important',
				),
				' .skt-blocks-call-mail-button-button-container:hover' => array(
					'border'           => $button_border_hover,
					'background-color' => $button_background_hover,
				),
				' .skt-blocks-call-mail-button-button-container:hover .skt-blocks-call-mail-button-text' => array(
					'color' => $text_color_hover,
				),
				' .skt-blocks-call-mail-button-button-container:hover .skt-blocks-call-mail-button-icon' => array(
					'fill' => $text_color_hover,
				),
				' .skt-blocks-call-mail-button-icon-iconPosition-left' => array(
					'margin-right' => self::get_css_value( $attr['iconTextGap'], 'px' ),
				),
				' .skt-blocks-call-mail-button-icon-iconPosition-right' => array(
			...
			$id  = '.skt-blocks-block-call-mail-button.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_progress_bar_css( $attr, $id ) {
			...
			$id  = '.skt-blocks-block-progress-bar.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_social_share_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-share-icon > a:first-child' => array(
				...
				' .skt-blocks-share-icon > a:last-child' => array(
					'padding' => ( 'boxed' === $attr['skin'] || 'minimal' === $attr['skin'] ) ? '0 10px 0 0' : '',
				),
				' .skt-blocks-share-icon-svg svg' => array(
					'height' => self::get_css_value( $attr['iconSize'], 'px' ),
					'width'  => self::get_css_value( $attr['iconSize'], 'px' ),
					'fill'   => 'custom' === $attr['iconColorType'] ? $attr['iconPrimaryColor'] : '',
				),
				' .skt-blocks-share-icons-container' => array(
					'display'               => 'inline-grid',
				...
				' .skt-blocks-share-icon-label' => array(
					'font-size'   => self::get_css_value( $attr['labelFontSize'], 'px' ),
					'font-family' => $attr['labelFontFamily'],
					'font-weight' => $attr['labelFontWeight'],
				...
				' .skt-blocks-icon-facebook, .skt-blocks-icon-facebook-f, .skt-blocks-icon-facebook-square, .skt-blocks-icon-facebook-messenger' => array(
					'fill' => '#3b5998',
				),
				' .skt-blocks-icon-twitter, .skt-blocks-icon-twitter-square' => array(
					'fill' => '#00aced',
				),
				' .skt-blocks-icon-linkedin, .skt-blocks-icon-linkedin-in' => array(
					'fill' => '#007bb6',
				),
				' .skt-blocks-icon-youtube, .skt-blocks-icon-youtube-square' => array(
					'fill' => '#bb0000',
				),
				' .skt-blocks-icon-pinterest, .skt-blocks-icon-pinterest-p, .skt-blocks-icon-pinterest-square' => array(
					'fill' => '#bb0000',
				),
				' .skt-blocks-icon-instagram' => array(
					'fill' => '#e95950',
				),
				' .skt-blocks-icon-snapchat, .skt-blocks-icon-snapchat-ghost,  .skt-blocks-icon-snapchat-square' => array(
					'fill' => '#fffc00',
				),
				' .skt-blocks-icon-tumblr, .skt-blocks-icon-tumblr-square' => array(
					'fill' => '#32506d',
				),
				' .skt-blocks-icon-vimeo, .skt-blocks-icon-vimeo-v, .skt-blocks-icon-vimeo-square' => array(
					'fill' => '#aad450',
				),
				' .skt-blocks-icon-quora' => array(
					'fill' => '#a82400',
				),
				' .skt-blocks-icon-google-plus, .skt-blocks-icon-google-plus-g, .skt-blocks-icon-google-plus-square' => array(
					'fill' => '#dd4b39',
				),
				' .skt-blocks-icon-reddit, .skt-blocks-icon-reddit-alien, .skt-blocks-icon-reddit-square' => array(
					'fill' => '#FF5700',
				),
				' .skt-blocks-icon-skype' => array(
					'fill' => '#00aff0',
				),
				' .skt-blocks-icon-telegram, .skt-blocks-icon-telegram-plane' => array(
					'fill' => '#0088cc',
				),
				' .skt-blocks-icon-whatsapp, .skt-blocks-icon-whatsapp-square' => array(
					'fill' => '#34B7F1',
				),
				' .skt-blocks-icon-envelope' => array(
					'fill' => '#BB001B',
				),
			);
			...
			$id  = '.skt-blocks-block-social-share.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_tabs_css( $attr, $id ) {
			...
			$selectors          = array(
				...
				' > .skt-blocks-tabs__panel .skt-blocks-tab.skt-blocks-tabs__active' => array(
					'background' => $attr['tabBackgroundColor'],
				),
				' > .skt-blocks-tabs__body-wrap ' => array(
					'background' => $attr['tabBackgroundColor'],
				),
				'.skt-blocks-tabs__wrap > .skt-blocks-tabs__panel .skt-blocks-tab' => array(
				...
				'.skt-blocks-tabs__wrap > .skt-blocks-tabs__panel .skt-blocks-tab.skt-blocks-tabs__active' => array(
					'border-style'        => $attr['tabBorderWidth'] > 0 ? 'solid' : 'none',
					'border-top-width'    => self::get_css_value( $attr['tabBorderWidth'], 'px' ),
					'border-left-width'   => $active_tab_border_left,
					'border-bottom-width' => $active_tab_border_bottom,
				...
				'.skt-blocks-tabs__wrap > .skt-blocks-tabs__body-wrap' => array(
					'border-width' => self::get_css_value( $attr['tabBorderWidth'], 'px' ),
					'border-color' => $attr['tabBorderColor'],
				),
				'  .skt-blocks-tabs__panel .skt-blocks-tab span' => array(
				...
				'  .skt-blocks-tabs__panel .skt-blocks-tab.skt-blocks-tabs__active span' => array(
					'color' => $attr['tabTitleActiveColor'],
				),
				' > .skt-blocks-tabs__body-wrap .wp-block-skt-blocks-tabs-child p' => array(
				...
				'.skt-blocks-vstyle8-right' => array(
			...
			$id                 = '.skt-blocks-block-tabs.block-' . $id;
			$css                = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_tabs_child_css( $attr, $id ) {
			...
			$id  = '.skt-blocks-block-tabs-child.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_taxonomy_list_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-block-list-item' => array(
			...
			$id  = '.skt-blocks-block-taxonomy-list.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_taxonomy_list_block_default_attributes() {
			return array(
				...
				'orderBy'                => 'date',
				'postsToShow'            => '8',
				'noTaxDisplaytext'       => __( 'Taxonomy Not Available.', 'skt-blocks' ),
				'showEmptyTaxonomy'      => false,
				'titleTag'               => 'div',
				'alignment'              => 'center',
				'listStyle'              => 'disc',
		...
		public static function get_responsive_block_wp_search_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-search-form__input' => array(
				...
				' .skt-blocks-search-form__input::placeholder' => array(
					'color'   => $attr['inputTextColor'],
					'opacity' => 0.6,
				),
				' .skt-blocks-search-submit' => array(
				...
				' .skt-blocks-search-submit:hover' => array(
					'background-color' => $attr['buttonBackgroundHoverColor'],
				),
				' .skt-blocks-search-icon-wrap' => array(
				...
				' .skt-blocks-search-icon-wrap svg' => array(
					'width'  => self::get_css_value( $attr['iconSize'], 'px' ),
					'height' => self::get_css_value( $attr['iconSize'], 'px' ),
					'fill'   => $icon_color,
				),
				'  .skt-blocks-search-submit:hover .skt-blocks-search-icon-wrap svg' => array(
					'fill' => $attr['iconHoverColor'],
				),
				' .skt-blocks-search-button-text' => array(
				...
				' .skt-blocks-search-button-text:hover' => array(
					'color' => $attr['buttonTextHoverColor'],
				),
			);

			if ( 'inset' === $attr['boxShadowPosition'] ) {
				$selectors[' .skt-blocks-search-form__input']['box-shadow'] = $box_shadow;
			} else {
			...
			$id  = '.skt-blocks-block-wp-search.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
			return $css;
		}
		...
		public static function get_responsive_block_instagram_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-intro-page' => array(
					'border'  => '1px solid black',
					'padding' => '0 20px',
				),
				' .skt-blocks-intro-page p > a' => array(
					'color' => 'blue',
				),
				' .skt-blocks-instagram-posts-container' => array(
					'grid-template-columns' => 'repeat(' . $attr['columns'] . ', 1fr)',
					'grid-gap'              => self::get_css_value( $attr['imagesGap'], 'px' ),
				),
				' .skt-blocks-instagram-image' => array(
					'border-radius' => self::get_css_value( $attr['borderRadius'], '%' ),
				),
				' .skt-blocks-instagram-wrapper' => array(
			...
			$id  = '.skt-blocks-block-instagram.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
		...
		public static function get_responsive_block_image_hotspot_css( $attr, $id ) {
			...
			$id  = '.skt-blocks-block-image-hotspot.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
		...
		public static function get_responsive_block_advanced_text_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .skt-blocks-text-container' => array(
					'padding' => self::get_css_value( $attr['contentPadding'], 'px' ),
				),
				' .skt-blocks-separator' => array(
			...
			$id  = '.skt-blocks-block-advanced-text.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
		...
		public static function get_responsive_block_feature_grid_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .wp-block-skt-blocks-feature-grid-item' => array(
					'border-color'     => $attr['blockBorderColor'],
					'border-style'     => $attr['blockBorderStyle'],
					'border-radius'    => self::get_css_value( $attr['blockBorderRadius'], 'px' ),
					'border-width'     => self::get_css_value( $attr['blockBorderWidth'], 'px' ),
				...
				' .wp-block-skt-blocks-feature-grid-item.background-type-image' => array(
					'background-image'      => 'linear-gradient(' .
						self::hex_to_rgb( '#fff', 1 - $imgopacity ) .
						',' .
						self::hex_to_rgb( '#fff', 1 - $imgopacity ) .
				...
				' .skt-blocks-feature-image' => array(
					'width' => self::get_css_value( $attr['imageWidth'], 'px' ),
				),
				' .skt-blocks-feature-image-wrap' => array(
					'margin-bottom' => self::get_css_value( $attr['imageSpace'], 'px' ),
				),
				' .wp-block-skt-blocks-feature-grid-item__title' => array(
					'color'          => $attr['titleColor'],
					'line-height'    => $attr['titleLineHeight'],
					'font-weight'    => $attr['titleFontWeight'],
					'font-size'      => self::get_css_value( $attr['titleFontSize'], 'px' ),
				...
				' .wp-block-skt-blocks-feature-grid-item__desc' => array(
					'color'          => $attr['descColor'],
				...
				' .wp-block-skt-blocks-feature-grid-item__button' => array(
					'display'          => 'block',
					'margin-left'      => 'left' === $attr['blockAlign'] ? 0 : '',
					'margin-right'     => 'right' === $attr['blockAlign'] ? 0 : '',
					'color'            => $attr['ctaColor'],
				...
				' .wp-block-skt-blocks-feature-grid-item__button:hover' => array(
					'color'            => $attr['ctaHoverColor'] . '!important',
			...
			$id  = '.wp-block-skt-blocks-feature-grid.block-' . $id;
			$css = Skt_Blocks_Frontend_Styles_Helper::skt_blocks_generate_all_css( $combined_selectors, $id );
